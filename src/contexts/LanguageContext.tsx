...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const translations = {
    sl: {
      ...
      'suites.deluxe.title': 'Deluxe Suite',
      'suites.deluxe.description': 'Luksuzna suite s pogledom na jezero, elegantno opremljena s prostorno sedežno in TV z ravnim zaslonom.',
      'suites.superior.title': 'Superior Suite',
      'suites.superior.description': 'Prostorna suite (65 m²) s 2 spalnicama, pogledom na jezero in grad. Primerna za družine ali skupine (do 4 osebe).',
      ...
      // Summer Packages
      'packages.lakeRetreat.title': 'Lake Retreat Package',
      'packages.lakeRetreat.description': 'A serene escape featuring lake-view accommodation, daily breakfast, and curated lakeside experiences.',
      'packages.lakeRetreat.badge': 'Best Seller',
      'packages.lakeRetreat.highlight1': '3 nights in a Lake View Suite',
      'packages.lakeRetreat.highlight2': 'Daily gourmet breakfast on the terrace',
      'packages.lakeRetreat.highlight3': 'Private boat ride to Bled Island',
      'packages.lakeRetreat.highlight4': 'Welcome bottle of Slovenian wine',
      'packages.romanticEscape.title': 'Romantic Escape',
      'packages.romanticEscape.description': 'The ultimate couples retreat with champagne, spa treatments, and a private dinner on the lake terrace.',
      'packages.romanticEscape.badge': 'Most Popular',
      'packages.romanticEscape.highlight1': '3 nights in the Princess Suite',
      'packages.romanticEscape.highlight2': 'Champagne welcome with chocolate-covered strawberries',
      'packages.romanticEscape.highlight3': 'Couples massage in the wellness center',
      'packages.romanticEscape.highlight4': 'Private candlelit dinner on the lake terrace',
      'packages.romanticEscape.highlight5': 'Rose petal turndown service',
      'packages.alpineAdventure.title': 'Alpine Adventure',
      'packages.alpineAdventure.description': 'Explore the Julian Alps with guided hikes, bike tours, and a full-day excursion to Triglav National Park.',
      'packages.alpineAdventure.badge': 'Adventure',
      'packages.alpineAdventure.highlight1': '4 nights in a Luxury Suite',
      'packages.alpineAdventure.highlight2': 'Guided hike to Ojstrica viewpoint',
      'packages.alpineAdventure.highlight3': 'Full-day Triglav National Park excursion',
      'packages.alpineAdventure.highlight4': 'Complimentary mountain bike rental',
      'packages.culinaryDelight.title': 'Culinary Delight',
      'packages.culinaryDelight.description': 'A gastronomic journey featuring a wine tasting, cooking class, and dinner at a Michelin-recommended restaurant.',
      'packages.culinaryDelight.badge': 'Gourmet',
      'packages.culinaryDelight.highlight1': '2 nights in a Deluxe Suite',
    ...
    en: {
      ...
      'suites.deluxe.title': 'Deluxe Suite',
      'suites.deluxe.description': 'A luxurious lake-view suite with elegant furnishings, spacious seating area, and flat-screen TV.',
      'suites.superior.title': 'Superior Suite',
      'suites.superior.description': 'A spacious 2-bedroom suite (65 m²) with lake and castle views. Perfect for families or groups (sleeps 4).',
      'suites.island.title': 'Island Suite',
      ...
      'workation.pageDesc': 'Work remotely from Villa Adora Bled — high-speed WiFi, dedicated workspaces, and lake views.',
      'workation.badge': 'Remote Work & Relax',
      'workation.heroTitle': 'Work From Paradise',
      'workation.heroDesc': 'Combine productivity with relaxation. Villa Adora offers fiber optic WiFi, dedicated workspaces in every suite, and inspiring lake views.',
      'workation.cta': 'Book Your Workation',
      'workation.contactUs': 'Contact Us',
      'workation.featuresTitle': 'Everything You Need to Stay Productive',
      'workation.featuresDesc': 'From high-speed internet to inspiring outdoor workspaces, Villa Adora has everything you need for a productive and rejuvenating workation.',
      'workation.fiber.title': 'Fiber Optic WiFi',
      'workation.fiber.desc': 'High-speed fiber optic internet (up to 300 Mbps) throughout the property. Video calls, large file uploads, and streaming — all seamless.',
      'workation.workspace.title': 'Dedicated Workspace',
      'workation.workspace.desc': 'Every suite features a dedicated workspace with an ergonomic chair, desk, and power outlets.',
      'workation.terrace.title': 'Outdoor Workspaces',
      'workation.terrace.desc': 'Take your laptop to the terrace or garden. Work with inspiring lake views and fresh alpine air.',
      'workation.wellness.title': 'Wellness Breaks',
      'workation.wellness.desc': 'Recharge with a sauna session, massage, or yoga on the terrace. Wellness is complimentary for all guests.',
      'workation.flexible.title': 'Flexible Booking',
      'workation.flexible.desc': 'No minimum stay for workation packages. Early check-in and late check-out available on request.',
      'workation.value.title': 'Exceptional Value',
      'workation.value.desc': 'Workation packages include breakfast, wellness, parking, and airport transfer. Save up to 20% compared to standard rates.',
      'workation.packagesTitle': 'Workation Packages',
      'workation.packagesDesc': 'Choose the package that fits your workation needs. All packages include high-speed WiFi, workspace, and wellness access.',
      'workation.bestValue': 'Best Value',
      'workation.bookNow': 'Book Now',
      'workation.stay5.name': '5 Nights — Starter',
      'workation.stay5.price': '€450/night',
      'workation.stay5.perk1': 'High-speed fiber WiFi',
      'workation.stay5.perk2': 'Dedicated workspace',
      'workation.stay5.perk3': 'Daily breakfast',
      'workation.stay5.perk4': 'Wellness access',
      'workation.stay7.name': '7 Nights — Standard',
      'workation.stay7.price': '€380/night (15% off)',
      'workation.stay7.perk1': 'Everything in 5-night package',
      'workation.stay7.perk2': 'Airport transfer included',
      'workation.stay7.perk3': '1 complimentary massage',
      'workation.stay7.perk4': 'Late check-out',
      'workation.stay7.perk5': 'Welcome bottle of Slovenian wine',
      'workation.stay14.name': '14 Nights — Extended',
      'workation.stay14.price': '€340/night (20% off)',
      'workation.stay14.perk1': 'Everything in 7-night package',
      'workation.stay14.perk2': '2 complimentary massages',
      'workation.stay14.perk3': 'Cooking class experience',
      'workation.stay14.perk4': 'Private boat ride to Bled Island',
    ...
    de: {
      ...
      'suites.deluxe.title': 'Deluxe-Suite',
      'suites.deluxe.description': 'Eine luxuriöse Suite mit Seeblick, eleganten Möbeln, großzügigem Sitzbereich und Flachbild-TV.',
      'suites.superior.title': 'Superior-Suite',
      'suites.superior.description': 'Eine geräumige Suite mit 2 Schlafzimmern (65 m²) mit See- und Schlossblick. Ideal für Familien oder Gruppen (bis 4 Personen).',
      ...
      // Summer Packages
      'packages.lakeRetreat.title': 'See-Retreat-Paket',
      'packages.lakeRetreat.description': 'Ein ruhiges Erlebnis mit Seeblick-Unterkünftem, täglichem Frühstück und kuratierten Aktivitäten am See.',
      'packages.lakeRetreat.badge': 'Bestseller',
      'packages.lakeRetreat.highlight1': '3 Nächte in einer Seeblick-Suite',
      'packages.lakeRetreat.highlight2': 'Tägliches Gourmet-Frühstück auf der Terrasse',
      'packages.lakeRetreat.highlight3': 'Private Bootsfahrt zur Bled-Insel',
      'packages.lakeRetreat.highlight4': 'Willkommensflasche slowenischen Weins',
      'packages.romanticEscape.title': 'Romantische Flucht',
      'packages.romanticEscape.description': 'Das ultimative Paar-Retreat mit Champagner, Spa-Behandlungen und einem privaten Dinner am See.',
      'packages.romanticEscape.badge': 'Am beliebtesten',
      'packages.romanticEscape.highlight1': '3 Nächte in der Princess Suite',
      'packages.romanticEscape.highlight2': 'Champagner-Willkommen mit Schokoladen-Erdbeeren',
      'packages.romanticEscape.highlight3': 'Paarmassage im Wellnesscenter',
      'packages.romanticEscape.highlight4': 'Privates Kerzen-Dinner auf der Seeterrasse',
      'packages.romanticEscape.highlight5': 'Blütenblätter-Service am Abend',
      'packages.alpineAdventure.title': 'Alpen-Abenteuer',
      'packages.alpineAdventure.description': 'Erkunden Sie die Julischen Alpen mit geführten Wanderungen, Fahrradtouren und einem Tagesausflug zum Triglav-Nationalpark.',
      'packages.alpineAdventure.badge': 'Abenteuer',
      'packages.alpineAdventure.highlight1': '4 Nächte in einer Luxus-Suite',
      'packages.alpineAdventure.highlight2': 'Geführte Wanderung zum Ojstrica-Aussichtspunkt',
      'packages.alpineAdventure.highlight3': 'Ganztägiger Ausflug zum Triglav-Nationalpark',
      'packages.alpineAdventure.highlight4': 'Kostenlose Mountainbike-Vermietung',
      'packages.culinaryDelight.title': 'Kulinarische Freude',
      'packages.culinaryDelight.description': 'Eine gastronomische Reise mit Weinprobe, Kochkurs und Dinner in einem Michelin-empfohlenen Restaurant.',
      'packages.culinaryDelight.badge': 'Gourmet',
      'packages.culinaryDelight.highlight1': '2 Nächte in einer Deluxe-Suite',
    ...
    it: {
      ...
      'suites.deluxe.description': 'Una suite di lusso con vista sul lago, arredi elegante, zona seduta spaziosa e TV a schermo piatto.',
      'suites.superior.title': 'Suite Superior',
      'suites.superior.description': 'Una suite spaziosa con 2 camere da letto (65 m²) con vista sul lago e sul castello. Perfetta per famiglie o gruppi (fino a 4 persone).',
      ...
      // Summer Packages
      'packages.lakeRetreat.title': 'Pacchetto Ritiro al Lago',
      'packages.lakeRetreat.description': 'Un\'esperienza serena con alloggio con vista lago, colazione giornaliera e esperienze curate sul lago.',
      'packages.lakeRetreat.badge': 'Bestseller',
      'packages.lakeRetreat.highlight1': '3 notti in una Suite con vista lago',
      'packages.lakeRetreat.highlight2': 'Colazione gourmet giornaliera sulla terrazza',
      'packages.lakeRetreat.highlight3': 'Gita in barca privata all\'isola di Bled',
      'packages.lakeRetreat.highlight4': 'Bottiglia di benvenuto di vino sloveno',
      'packages.romanticEscape.title': 'Fuga Romantica',
      'packages.romanticEscape.description': 'Il rifugio definitivo per coppie con champagne, trattamenti spa e una cena privata sulla terrazza del lago.',
      'packages.romanticEscape.badge': 'Più popolare',
      'packages.romanticEscape.highlight1': '3 notti nella Princess Suite',
      'packages.romanticEscape.highlight2': 'Benvenuto con champagne e fragole al cioccolato',
      'packages.romanticEscape.highlight3': 'Massaggio per coppie nel centro wellness',
      'packages.romanticEscape.highlight4': 'Cena privata a lume di candela sulla terrazza del lago',
      'packages.romanticEscape.highlight5': 'Servizio serale con petali di rosa',
      'packages.alpineAdventure.title': 'Avventura Alpina',
      'packages.alpineAdventure.description': 'Esplorate le Alpi Giulie con escorti in mountain bike, escursioni guidate e un\'escursione di un giorno al Parco Nazionale del Triglav.',
      'packages.alpineAdventure.badge': 'Avventura',
      'packages.alpineAdventure.highlight1': '4 notti in una Suite Luxury',
      'packages.alpineAdventure.highlight2': 'Escursione guidata al punto di vista di Ojstrica',
      'packages.alpineAdventure.highlight3': 'Escursione di un giorno al Parco Nazionale del Triglav',
      'packages.alpineAdventure.highlight4': 'Noleggio gratuito di mountain bike',
      'packages.culinaryDelight.title': 'Delizia Culinaria',
      'packages.culinaryDelight.description': 'Un viaggio gastronomico con degustazione di vini, corso di cucina e cena in un ristorante raccomandato Michelin.',
      'packages.culinaryDelight.badge': 'Gourmet',
      'packages.culinaryDelight.highlight1': '2 notti in una Suite Deluxe',
